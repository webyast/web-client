#
# spec file for package rubygem-gettext_rails (Version 2.0.0)
#
...
BuildRequires:  rubygem-gettext_activerecord >= 2.0.0
Requires:       rubygem-gettext_activerecord >= 2.0.0
BuildRequires:  rubygem-locale_rails >= 2.0.0
Requires:       rubygem-locale_rails >= 2.0.0
